...
athletes = Daru::DataFrame.new(
  {
    ...
    :Draft => [false,false,false,false,false,false,false,false,false,false,false,false,false,true,true,true,true,true,true,true]
  },
  index: (1..20).to_a
)

prediction = KNN::knn(athletes,3,[6.75,3])
